 ...
 */
final class Version20231219092639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE portfolio (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, share_name VARCHAR(150) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, quantity INT DEFAULT NULL, total_price DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_A9ED106219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE share_transaction (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, share_name VARCHAR(150) DEFAULT NULL, share_price DOUBLE PRECISION DEFAULT NULL, quantity INT DEFAULT NULL, total_price DOUBLE PRECISION DEFAULT NULL, type VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_D4876C19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
